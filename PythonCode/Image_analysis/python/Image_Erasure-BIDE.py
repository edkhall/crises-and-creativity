...
# Read image
image = Image.open(GenPath + 'Art/Dali_dream_caused_by_the_flight_of_a_bee.jpg')#.convert('RGBA')
...
#plt.show()
anim.save(GenPath + 'Results/gifs/image-erasure_NeighborReplacement.gif', writer='imagemagick', fps=10)
sys.exit()
